...
if __name__ == '__main__':
    ...
    python main.py --DATE_TIME '0916_0026' --train_scene_scope 'bedroom_04' --train_task_scope '264' --test_scene_scope 'bedroom_04' --test_task_scope '264' --device_num 0 --vis False
    '''
